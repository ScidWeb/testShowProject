  ...
  var K = {
      ...
      C('inspectSource', function (t) {
        ...
        (t.exports = function (t, e, i, o) {
          var s = !!o && !!o.unsafe,
            ...
            l = !!o && !!o.noTargetGet;
          'function' == typeof i &&
            ('string' != typeof e || O(i, 'name') || W(i, 'name', e), (r(i).source = n.join('string' == typeof e ? e : ''))),
    ...
    Dt = function (t) {
      ...
      return function (a, c, l, u) {
        for (
          var f, h, d = Mt(a), p = y(d), v = Lt(c, l, 3), g = st(p.length), b = 0, m = u || Nt, x = e ? m(a, g) : r ? m(a, 0) : void 0;
          g > b;
          b++
        )
  ...
  var Qt =
    ...
    re =
      ...
      function (t, e) {
        var r;
        return (
          null !== t ? ((te.prototype = T(t)), (r = new te()), (te.prototype = null), (r[Zt] = t)) : (r = ee()), void 0 === e ? r : Kt(r, e)
        );
      };
  q[Zt] = !0;
  ...
  function ii(t) {
    ...
    if (
      ('border-box' === n.boxSizing &&
        (Math.round(a + o) !== e && (a -= ni(n, 'left', 'right') + o), Math.round(c + s) !== r && (c -= ni(n, 'top', 'bottom') + s)),
      !(function (t) {
    ...
    function t(e, r) {
      ...
      (this.onScroll = function () {
        ...
        (this.drag = function (e) {
          ...
          var c =
            ((('y' === n.draggedAxis ? e.pageY : e.pageX) - r.rect[n.axis[n.draggedAxis].offsetAttr] - n.axis[n.draggedAxis].dragOffset) /
              (i - o.size)) *
            (s - a);
          'x' === n.draggedAxis &&
    ...
    return (
      (e.init = function () {
        t.instances.set(this.el, this),
          Yt && (this.initDOM(), (this.scrollbarWidth = this.getScrollbarWidth()), this.recalculate(), this.initListeners());
      }),
      (e.initDOM = function () {
        var t = this;
        if (
