  ...
  return (function (t) {
      ...
      o('inspectSource', function (t) {
        ...
        (t.exports = function (t, n, e, o) {
          var s = !!o && !!o.unsafe,
            ...
            f = !!o && !!o.noTargetGet;
          'function' == typeof e &&
            ('string' != typeof n || c(e, 'name') || i(e, 'name', n), (l(e).source = d.join('string' == typeof n ? n : ''))),
            t !== r ? (s ? !f && t[n] && (u = !0) : delete t[n], u ? (t[n] = e) : i(t, n, e)) : u ? (t[n] = e) : a(n, e);
    ...
    function (t, n, e) {
      ...
      (t.exports =
        ...
        function (t, n) {
          var e;
          return (
            null !== t ? ((f.prototype = r(t)), (e = new f()), (f.prototype = null), (e[u] = t)) : (e = l()), void 0 === n ? e : o(e, n)
          );
        }),
        (c[u] = !0);
    },
      ...
      var r = e(49),
        ...
        u = function (t) {
          ...
          return function (p, v, h, g) {
            for (
              var y, m, b = i(p), x = o(b), w = r(v, h, 3), S = c(x.length), O = 0, _ = g || a, E = n ? _(p, S) : e ? _(p, 0) : void 0;
              S > O;
              O++
            )
      ...
      t.exports = function (t, n, e, f, p, m, b) {
        ...
        if (
          (C &&
            ...
            v !== Object.prototype &&
              x.next &&
              (l || i(x) === v || (c ? c(x, v) : 'function' != typeof x[g] && s(x, g, y)), a(x, _, !0, !0), l && (d[_] = y))),
          'values' == p &&
            j &&
            'values' !== j.name &&
            ((E = !0),
          ...
          if (((w = { values: O('values'), keys: m ? A : O('keys'), entries: O('entries') }), b))
    ...
    function (t, n, e) {
      ...
      var r = e(4),
        ...
        rt = function (t, n) {
          ...
          return B(e, { type: 'Symbol', tag: t, description: n }), c || (e.description = n), e;
        },
        ot =
        ...
        it = function (t, n, e) {
          ...
          return (
            ...
            u(J, r)
              ? (e.enumerable
                  ? (u(t, N) && t[N][r] && (t[N][r] = !1), (e = y(e, { enumerable: g(0, !1) })))
                  : (u(t, N) || q(t, N, g(1, {})), (t[N][r] = !0)),
                et(t, r, e))
              : q(t, r, e)
          );
        },
      ...
      a ||
        (L(
          (H = function () {
            ...
            return c && nt && et(G, n, { configurable: !0, set: e }), rt(n, t);
          }).prototype,
          'toString',
          function () {
            return W(this).tag;
        ...
        c &&
          ...
          i || L(G, 'propertyIsEnumerable', at, { unsafe: !0 })),
        (M.f = function (t) {
          return rt(P(t), t);
        })),
        ...
        r({ target: 'Object', stat: !0, forced: !a }, { getOwnPropertyNames: ut, getOwnPropertySymbols: ft }),
        r(
          {
            target: 'Object',
            stat: !0,
    ...
    function (t, n, e) {
      ...
      t.exports = function (t) {
        ...
        else for (d = (l = b.call(p)).next, e = new v(); !(f = d.call(l)).done; m++) s(e, m, y ? i(l, g, [f.value, m], !0) : f.value);
        return (e.length = m), e;
      };
    },
    function (t, n, e) {
    ...
    function (t, n, e) {
      ...
      t.exports = function (t, n, e) {
        var u = n + ' Iterator';
        return (t.prototype = o(r, { next: i(1, e) })), c(t, u, !1, !0), (a[u] = s), t;
      };
    },
    function (t, n, e) {
      var r = e(2);
          ...
          if (c) {
            ...
            if (
              ...
              (a = [].concat(r(a), [e])),
                ...
                s || (document.addEventListener('touchmove', p, o ? { passive: !1 } : void 0), (s = !0));
            }
          } else {
            !(function (t) {
              setTimeout(function () {
        ...
        g = function (t) {
          if (c) {
            ...
            (t.ontouchstart = null),
              ...
              s && 0 === a.length && (document.removeEventListener('touchmove', p, o ? { passive: !1 } : void 0), (s = !1));
          } else
            (a = a.filter(function (n) {
              return n.targetElement !== t;
            })).length || v();
                ...
                for (var i = 0; i <= 1; i++) {
                  var c = document.createElement('div'),
                    a = '<svg\n      height="15"\n      width="15"\n       style="\n       transform: \n       scale('
                      ...
                      .concat(
                        0 === i ? (this.settings.verticalMode ? '-90deg' : '180deg') : this.settings.verticalMode ? '90deg' : '0deg',
                        '); height: '
                      )
                      .concat('20', 'px; width: ')
                      .concat('20', 'px;\n       \n       ')
                      ...
                      .concat(
                        this.settings.addCircle ? 'fill="transparent"' : 'fill="'.concat(this.settings.controlColor, '"'),
                        '\n       stroke="'
                      )
